...
const FEATURED: MarketplaceAPI[] = [
  { id: "blue-research",    name: "Blue Research",       provider: "Blue Agent", desc: "Base ecosystem deep-dive — structured research report with citations + next-step recommendations. The 6th core Blue Command.", category: "Intelligence", price: "$0.10", priceNum: 0.10, endpoint: "api.blueagent.dev/api/blue-research", calls: 0, verified: true, aiReady: true, featured: true, status: "live", releasedAt: "2026-06-08", icon: "🔬" },

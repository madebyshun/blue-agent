...
const TIER_ROWS: { need: string; tier: string; perk: string; color: string }[] = [
  { need: "No wallet", tier: "Guest",   perk: "5,000 cr/day", color: "#64748b" },
          ...
          {showHelp && (
            <div className="mt-2 rounded-2xl bg-[#0A0A12] border border-[#1A1A2E] p-4 space-y-3">
              <p className="font-mono text-[10px] text-slate-500 leading-relaxed">
                With no wallet you get <span className="text-[#4FC3F7]">5,000 free credits/day</span> — enough to test the tools.

...
const TIER_ENDPOINTS: Record<number, string> = {
  1: `https://x402.bankr.bot/${TREASURY}/launch-simulator`,
  2: `https://x402.bankr.bot/${TREASURY}/launch-simulator-2`,
  3: `https://x402.bankr.bot/${TREASURY}/launch-simulator-3`,
};

...
export default async function handler(req: Request): Promise<Response> {
  try {
    ...
    return Response.json({ ...result, disclaimer: "Forward-looking projection generated by AI from public research — speculative milestone dates, not a forecast backed by a live data feed." });
  } catch (error) {

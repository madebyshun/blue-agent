...
export default function ConsolePage({ inShell = false }: { inShell?: boolean }) {
  ...
  return (
    <div className={inShell ? "flex flex-col h-full bg-[#050508]" : ""}>
      ...
      {inShell && (
        <AppPageHeader
          label="CONSOLE"
          subtitle="blue idea · build · audit · ship · raise — free tier"
          accent="#34D399"
          right={<span className="text-[10px] px-1.5 py-0.5 border border-[#34D399]/30 text-[#34D399] rounded">Free</span>}
        />
      )}

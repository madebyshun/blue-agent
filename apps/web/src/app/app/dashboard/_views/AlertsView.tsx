...
/**
 * AlertsView — extracted from the former /app/alerts page so it can render
 * inside /app/dashboard as a tab. Outer page wrapper + AppPageHeader are
 * dropped; the dashboard tab shell provides them.
 */

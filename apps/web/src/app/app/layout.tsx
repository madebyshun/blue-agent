...
const APP_NAV = [
  ...
  },
  {
    ...
    href: "/app/dashboard",
    icon: (
      // Squares grid — single-glance overview of wallet, stake, alerts.
      <svg style={{ width: 18, height: 18 }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round"
...
const APP_BOTTOM = [
  // Profile sidebar slot retired — its content now lives at /app/dashboard.
  // /app/profile redirects there so existing bookmarks still resolve.
  {
    id: "docs",
    label: "Docs",
    href: "/docs",

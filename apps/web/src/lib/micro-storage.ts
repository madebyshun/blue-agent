  ...
  const tasks: MicroTask[] = [
    {
      ...
      description: "Quote tweet @blueagent_'s pinned tweet with any comment + a 🚀 emoji. Must be a public tweet from your account.",
      creator_address: "0x" + "f".repeat(40),
      creator_handle: "moltycash",
      platform: "x",
      proof_required: "quote",
      must_mention: "blueagent_",
